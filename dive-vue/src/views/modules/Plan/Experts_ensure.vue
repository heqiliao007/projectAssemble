                    ...
                    <div class="box_one" style="position:relative">
                      ...
                      <!-- 表格 -->
                        ...
                        <el-table
                          ...
                          style="width: 100%"
                        >
                        <el-table-column prop="date" label="选择专家" align="center" ></el-table-column>
                        <el-table-column prop="date" label="专家类型" align="center" ></el-table-column>
                        ...
                        <el-table-column prop="date" label="职务" align="center" ></el-table-column>
                        <el-table-column prop="date" label="保障方式" align="center"></el-table-column>
                        <el-table-column prop="date" label="电话" align="center"></el-table-column>
                        <el-table-column prop="date" label="向专家联络" align="center"></el-table-column>

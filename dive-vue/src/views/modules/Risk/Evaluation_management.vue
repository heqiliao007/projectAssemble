                    ...
                    <div class="box_one">
                      <div class="title_one">评估小结</div>
                        ...
                        <el-table
                          ...
                          style="width: 100%; min-height:635px;"
                        >
                        <el-table-column>
                          <el-table-column prop="address" label="项目类别" width="250" align="center"></el-table-column>
                        </el-table-column>
                        <el-table-column>
                          <el-table-column prop="date" label="项目数" align="center"></el-table-column>
                        </el-table-column>
                        <el-table-column label="各类别风险的项目数量" align="center">
                          <el-table-column prop="date" label="无" align="center"></el-table-column>
                          <el-table-column prop="date" label="低" align="center"></el-table-column>
                          <el-table-column prop="date" label="较低" align="center"></el-table-column>
                          <el-table-column prop="date" label="中" align="center"></el-table-column>
                          <el-table-column prop="date" label="较高" align="center"></el-table-column>
                          <el-table-column prop="date" label="高" align="center"></el-table-column>
                          <el-table-column prop="date" label="很高" align="center"></el-table-column>
                          <el-table-column prop="date" label="极高" align="center"></el-table-column>
                        </el-table-column>
                        </el-table>
                        </div>

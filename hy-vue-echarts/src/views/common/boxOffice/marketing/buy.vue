        ...
        <el-card>
          ...
          <div>
            ...
            >
              ...
              <el-table-column prop="score" label="购票指数"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    perceiveDate (val) {
      this.$http({
        url: this.$http.adornUrl('/web/ticketingindex/rankingVerTwo/'+ val +'/'+ this.isOnshow+'?current='+this.page+'&size=10'),
        method: 'get'
      }).then(({ data }) => {

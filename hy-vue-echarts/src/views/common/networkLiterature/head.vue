  ...
  <div>
    ...
    <div class="isFixed">
      <div style="height:86px; background:#4c4c4c; color: #fff; border: none; overflow: hidden;">
        ...
        <div style="width: 62%;margin: 0 auto;">
          ...
          >
            <el-menu-item v-for="rec in recommondData" :index="rec.id" :key="rec.id" style="display: flex; flex-direction: column;">
              <img style="margin: 0 auto; width: 36px; margin-top: 10px; " :src="rec.icon" alt="">
        ...
        <div class="header_right">
          ...
          <span class="el-dropdown-link" :style='"color:" + color'>
            ...
            <el-dropdown-menu slot="dropdown" style="zz-index:9999999">
      ...
      <div>
        ...
        <div style="background:#fff;height:40px;" v-if="subMemuList.length > 0">
          <div style="margin: 0 auto;text-align:left">
            <div class="search-button_network">
                <!-- <i class="iconfont iconshaixuan" style="margin-right: 5px;"></i> -->
              <span>{{pageword}}</span>
            </div>
            <!-- <p class="title_header_siging">
...
import wangwenfenxi from './img/wangwenfenxi.png'
import wenxueleixing from './img/wenxueleixign.png'
import zuopingpaihang from './img/zuopingpaihang.png'
export default {
  ...
  data() {
    return {
      ...
      recommondData: [
        // {id: '1', name: '文学类型', icon: wenxueleixing},
        // {id: '2', name: '作品排行', icon: zuopingpaihang},
        // {id: '3', name: '网文分析', icon: wangwenfenxi, children: [
        //   {id: '21', name: '文学作品'},
        //   {id: '22', name: '签约平台'}
        // ]}
      ],
  ...
  methods: {
    ...
    // getList(){
    //   this.$http({
    //     url: this.$http.adornUrl('/web/product/navigationbar/6'),
    //     method: 'get'
    //   }).then(({ data }) => {
    //     console.log(data)
    //     var menu=[]
    ...
    //       console.log(msg.navigationbars[i].id)
    //       this.$http({
    ...
    //             console.log(data.navigationbars)
    ...
    //     this.pageword = '网文分析 > 作品排行榜'
    //   }
    //   if (selected.name == '签约平台') {
    //     this.pageword = '网文分析 > 签约平台'
    //   }
    // },
    getList(){
      this.$http({

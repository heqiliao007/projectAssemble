  ...
  <div class="invest">
    ...
    <div class="breadcrumb">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>投资风向</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 标题 -->
    <!-- <div class="hend">
    ...
    <div class="body" v-loading='loading'>
      <ul v-if="analysislist">
        <li v-for="item in analysislist" :key="item.id">
          ...
          <div class="bth"><a :href="item.file_url" target="_blank">浏览报告</a></div>
        </li>
      </ul>
...
export default {
  ...
  methods:{
    ...
    grtanalysis(val){
      ...
      this.$http({
        url: this.$http.adornUrl(`/web/investmenttrend/webpage/${this.id}`),
        method:'post',
        data: this.$http.adornData({
          recYear:this.year+'' || year+''
        })
      }).then(({data}) => {
        console.log(data)
        if(!data.code){
          this.analysislist = data.page.list
          this.loading = false
        }
      })
    },
